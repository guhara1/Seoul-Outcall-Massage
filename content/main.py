...
<section id="purpose">
  ...
  <ul>
    <li><a href="/purpose/home/"><strong>자택 이용</strong></a> — 공동현관·주차 가능 여부와 정확한 주소 확인</li>
    <li><a href="/purpose/hotel/"><strong>호텔·숙소 이용</strong></a> — 숙소 이용 가능 여부와 예약 시간, 출입 절차 확인</li>
    <li><a href="/purpose/officetel/"><strong>오피스텔 이용</strong></a> — 로비 출입, 엘리베이터 카드 등 건물 출입 방식 확인</li>
    <li><a href="/purpose/business/"><strong>업무지구 예약</strong></a> — 빌딩 출입 절차와 방문 가능 시간대 확인</li>
    <li><a href="/purpose/night/"><strong>야간 예약</strong></a> — 야간 방문 가능 시간과 추가 안내 확인</li>
    <li><a href="/purpose/foreigner/"><strong>외국인 숙소 인접권</strong></a> — 이태원·한남 등 숙소 인접권의 예약·출입 기준 확인</li>
  </ul>
  <p>이용 목적별 상세는 <a href="/purpose/">이용 목적별 안내</a>에서 확인하고, 예약 전 점검은 <a href="/check/">이용 전 확인사항</a>과 <a href="/reservation/">예약 안내</a>를 참고하세요.</p>
</section>
